...
<objective>
Initialize Valenty in the current Flutter project. Add valenty_test dependency,
scan the codebase, and generate the first test scenarios.
</objective>
...
```
question: "I scanned your project. Which feature should we test first?"
options:
  - <most testable feature found> (recommended)
  - <second feature>
  - <third feature>
  - Let me describe a different one
```
...
Present the test names to the user with AskUserQuestion before generating code.
